...
app=Client(
    ...
    bot_token = '6802039492:AAFP9j8wMu2ZqQa5xsj2gc8aGLx654jFyj8')
...
async def start(app, msg):
    if msg.from_user.id == 6376489778:
        await msg.reply_text(text=f'''𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒃𝒐𝒕 {msg.from_user.first_name}''', reply_markup=ReplyKeyboardMarkup(
          [
          [f"𝖨𝗇𝖥𝗈"],
          ["𝖱𝗎𝖭","𝗌𝖳𝗈𝖯"],
          ["𝖠𝖣𝖣 𝗎𝖲𝖾𝖱","𝖠𝖣𝖣 𝗌𝖫𝖾𝖤𝗉"],
          ["𝖠𝖣𝖣 𝖠𝖼𝖼𝗈𝗎𝗇𝖳","𝖣𝖾𝖫𝖾𝖳 𝖠𝖼𝖼𝗈𝗎𝗇𝖳","𝖣𝖾𝖫𝖾𝖳 𝖠𝗅𝗅 𝖠𝖼𝖼𝗈𝗎𝗇𝖳𝗌"]
          ]
))
    else:
